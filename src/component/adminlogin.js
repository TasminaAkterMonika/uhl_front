    ...
    handleSubmit = event => {
        ...
        if (this.validateForm()) {
            ...
            .then(res => {
                ...
                let doctor_name = '';
                let doctor_fees = '';
                let patientName = res.data.username;
                let schedule_time = '';
                let search_selected_doc_name = '';
                let doctor_profile_avability = this.props.doctorProfilePageClick;
                if (!!res.token) {
                    startUserSession(res.token, res.data.role, res.data.email, res.data.id, phone_number, search_selected_doc_id, schedule_date, apointment_id, doctor_name, doctor_fees, patientName, schedule_time, search_selected_doc_name, doctor_profile_avability);
