		                                                        	...
		                                                        	{ this.state.bannerbtnlink.length > 0
                  														?
	                  														this.state.bannerbtnlink.map(bannerbtndata => {
	                  															let dept_name = bannerbtndata.department_name;
                    															let new_department_name = dept_name.replaceAll(' ', '-');
						                                                        return ( 
							                                                        <tr key={bannerbtndata.id}>
							                                                            ...
							                                                            {/*<td>{SITE_URL+'/pages/'+bannerbtndata.de}</td>*/}
							                                                            <td>{SITE_URL+'/departments/'+new_department_name+ '~' + bannerbtndata.department_id}</td>
							                                                            <td>
