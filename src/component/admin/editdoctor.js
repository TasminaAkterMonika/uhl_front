...
class EditDoctor extends Component {
    ...
    validateForm() {
        ...
        if (!this.state.edit_doctor_uhl_id) {
            formIsValid = false;
            errors["edit_doctor_uhl_id"] = "*Please enter your doctor uhl id.";
        }
        if (!this.state.edit_doctor_bmdc_id) {
            formIsValid = false;
            errors["edit_doctor_bmdc_id"] = "*Please enter your doctor bmdc id.";
        }
        this.setState({
            errors: errors
        });
    ...
    handleSubmit = event => {
        ...
        if (this.validateForm()===true) {
            ...
            const data = {
                ...
                edit_doctor_uhl_id:this.state.edit_doctor_uhl_id,
                edit_doctor_bmdc_id:this.state.edit_doctor_bmdc_id,
        ...
        .then(res => {
            if(res.status===true){
                ...
                this.setState({
                    ...
                    edit_doctor_uhl_id:records.uhl_id,
                    edit_doctor_bmdc_id:records.bmdc_id,
                });
            } else {
                this.setState({ 
                    doctor_id: '', 
                                        ...
                                        <div className="card-body">
                                            ...
                                            <form onSubmit={this.handleSubmit} id="editdoctorform" className="needs-validation" noValidate>
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            <label>Doctor UHL Id:</label>
                                                            <input type="text" className="form-control" name="edit_doctor_uhl_id" id="edit_doctor_uhl_id" value={this.state.edit_doctor_uhl_id} onChange={this.handleChange} required placeholder="Doctor UHL Id"/>
                                                            <span style={alertStyle}>{this.state.errors.edit_doctor_uhl_id}</span>
                                                        </div>
                                                    </div>
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            <label>Doctor BMDC Id</label>
                                                            <input type="text" className="form-control" name="edit_doctor_bmdc_id" id="edit_doctor_bmdc_id" value={this.state.edit_doctor_bmdc_id} onChange={this.handleChange} required placeholder="Doctor BMDC Id"/>
                                                            <span style={alertStyle}>{this.state.errors.edit_doctor_bmdc_id}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="row">
