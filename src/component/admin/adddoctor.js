...
class adddoctor extends Component {
    ...
    validateForm() {
        ...
        if (!this.state.doctor_uhl_id) {
            formIsValid = false;
            errors["doctor_uhl_id"] = "*Please enter your doctor uhl id.";
        }
        if (!this.state.doctor_bmdc_id) {
            formIsValid = false;
            errors["doctor_bmdc_id"] = "*Please enter your doctor bmdc id.";
        }
        this.setState({
            errors: errors
        });
    ...
    handleSubmit = event => {
        ...
        if (this.validateForm()===true) {
            const data = {
                ...
                doctor_uhl_id: this.state.doctor_uhl_id,
                doctor_bmdc_id: this.state.doctor_bmdc_id,
            }
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="text" className="form-control" name="doctor_uhl_id" id="doctor_uhl_id" value={this.state.doctor_uhl_id} onChange={this.handleChange} required placeholder="Doctor UHL Id"/>
                                                            <span style={alertStyle}>{this.state.errors.doctor_uhl_id}</span>
                                                        </div>
                                                    </div>
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            <label>Doctor BMDC Id</label>
                                                            <input type="text" className="form-control" name="doctor_bmdc_id" id="doctor_bmdc_id" value={this.state.doctor_bmdc_id} onChange={this.handleChange} required placeholder="Doctor BMDC Id"/>
                                                            <span style={alertStyle}>{this.state.errors.doctor_bmdc_id}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="row">
