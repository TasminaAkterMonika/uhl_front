...
const updatepackage = (id, data, edit_package_description, imageData, imageBannerData) => {
    let formdata = new FormData();
    formdata.append('edit_package_description', edit_package_description);
    formdata.append('edit_package_profile', imageData);
    formdata.append('edit_package_banner_image', imageBannerData);
...
class EditPackage extends Component {
    ...
    onBannerFileChange (file) {
        this.setState({ 
            edit_package_banner_image: file[0],
        })
    }
    handleSubmit = event => {
        ...
        if (this.validateForm()===true) {
            ...
            updatepackage(id, data, this.state.edit_package_description, this.state.edit_package_profile, this.state.edit_package_banner_image)
            .then(res => {
        ...
        .then(res => {
            if(res.status===true){
                ...
                this.setState({
                    ...
                    edit_package_banner_image: records.banner_image,
                                                    ...
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            ...
                                                            <select className="form-control" value={this.state.edit_package_age} name="edit_package_age" onChange={this.handleChange}>
                                                                ...
                                                                <option value="20-45">Adult (20-45)</option>
                                                                <option value="45+">Senior (45+)</option>
                                                            </select>
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            ...
                                                            <div className="package_profile_show_img_sec mb-2"><img src={IMAGE_URL+'/Packagesimg/'+this.state.edit_package_profile} alt="" width="130px"/></div>
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            ...
                                                            <div className="package_banner_show_img_sec mb-2"><img src={IMAGE_URL+'/PackagesBannerimg/'+this.state.edit_package_banner_image} alt="" width="130px"/></div>
                                                            <input type="file" className="form-control" name="edit_package_banner_image" id="edit_package_banner_image" onChange={ (event) => this.onBannerFileChange(event.target.files) } accept="jpg,png" placeholder="Doctor Fees"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="form-group">
