...
const savePackage = (data, package_desc,imageData, imageBannerData) => {
    let formdata = new FormData();
    formdata.append('package_desc', package_desc);
    formdata.append('package_profile', imageData);
    formdata.append('package_banner_image', imageBannerData);
...
class addpackage extends Component {
    ...
    handleSubmit = event => {
        ...
        if (this.validateForm()===true) {
            ...
            savePackage(data, this.state.package_desc,this.state.package_profile,this.state.package_banner_image)
            .then(res => {
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="file" className="form-control" name="package_banner_image" id="package_banner_image" onChange={ (event) => this.onBannerFileChange(event.target.files) } accept="jpg,png" placeholder="Doctor Fees"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="form-group">
