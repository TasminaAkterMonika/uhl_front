...
const updateDepartment = (id, data, edit_department_desc_one, edit_department_desc_two, edit_department_desc_three, edit_department_desc_four, edit_department_desc_five,edit_department_image,edit_department_banner_image) => {
    ...
    formdata.append('edit_department_banner_image', edit_department_banner_image);
...
class EditDepartment extends Component {
    ...
    onBannerFileChange (file) {
        this.setState({ 
            edit_department_banner_image: file[0],
        })
    }
    ...
    handleSubmit = event => {
        ...
        if (this.validateForm()===true) {
            ...
            updateDepartment(id, data, this.state.edit_department_desc_one, this.state.edit_department_desc_two, this.state.edit_department_desc_three, this.state.edit_department_desc_four, this.state.edit_department_desc_five,this.state.edit_department_image,this.state.edit_department_banner_image)
            .then(res => {
        ...
        .then(res => {
            if(res.status===true){
                ...
                this.setState({
                    ...
                    edit_department_image: records.image,
                    edit_department_banner_image: records.banner_image,
                });
            } else {
                this.setState({ 
                    department_id: '',
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            ...
                                                            <div className="department_icon_show_img_sec mb-2"><img src={IMAGE_URL+'/DepartmentImage/'+this.state.edit_department_image} alt="" width="130px"/></div>
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            ...
                                                            <div className="department_banner_show_img_sec mb-2"><img src={IMAGE_URL+'/DepartmentBannerImage/'+this.state.edit_department_banner_image} alt="" width="130px"/></div>
                                                            <input type="file" className="form-control" name="edit_department_banner_image" id="edit_department_banner_image" onChange={ (event) => this.onBannerFileChange(event.target.files) } accept="jpg,png"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="form-group">
